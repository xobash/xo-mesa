...
Record OS, hardware, workload, sample count, p95, and maximum. Browser and CI
timings do not pass these native rows.
...
| Idle/minimized app CPU | <= 1% of one logical core over five minutes, excluding active sync/research |  |  |
