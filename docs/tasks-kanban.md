...
Blank checkbox lines do not create tasks. The parser rejects long whitespace
runs without repeated body scans, so these lines do not freeze the dashboard.
