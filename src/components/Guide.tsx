...
const STEPS: Step[] = [
  {
    ...
    body: (
      <>
        ...
        graph side by side. Drag a view header to a workspace edge and release
        to open a native window. Drag its title bar back over Mesa to dock it.
      </>
    ),
    art: FolderArt,
  },
  ...
  },
  {
    ...
    body: (
      <>
        <b>Ctrl/Cmd+P</b> jumps to any note, <b>Ctrl/Cmd+Shift+F</b> searches text,{" "}
  ...
  },
  {
    ...
    body: (
      <>
        ...
        still requires the sync key. Open Sync to compare conflict copies.
        The status bar shows pending text saves and recovery actions.
        Pi and Research headers also support <b>Ctrl/Cmd+Shift+Enter</b> to transfer windows.
      </>
    ),
    art: SparkArt,
  },
...
export function Tour() {
  ...
  return (
    <Modal onClose={finish} className="guide" title="Mesa tour">
...
export function HelpModal() {
  ...
  if (!open) return null;
  return (
    <Modal onClose={() => setOpen(false)} className="guide help" title="How Mesa works">
